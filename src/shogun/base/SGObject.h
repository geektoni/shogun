...
public:
	...
	/**
	  ...
	  */
	rxcpp::observable<int> get_parameters_observable()
	{
...
protected:
	...
	*/
	template <class T>
	void observe_scalar(const std::string& name, const T& value);
...
private:
	...
	rxcpp::subjects::subject<int> m_subject_params;

	/** Parameter Observable */
	rxcpp::observable<int> m_observable_params;

	/** Subscriber used to call onNext, onComplete etc.*/
	rxcpp::subscriber<int> m_subscriber_params;
};
}
